/*
 CampusFix - complete standalone SQL Server schema (Flyway V1 through V7)
...
IF DB_ID(N'campusfix') IS NULL
BEGIN
    EXEC(N'CREATE DATABASE [campusfix]');
END;
GO
...
IF EXISTS (
    ...
    THROW 51010, 'campusfix_full_schema.sql must run on an empty database.', 1;
GO
...
/* ===== CAMPUSFIX FULL SCHEMA COMPLETED ===== */
