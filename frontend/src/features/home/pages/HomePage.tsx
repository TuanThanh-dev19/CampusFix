...
const modules = [
  ...
  [
    'Equipment',
    'Types, asset codes, locations, status, and maintenance history',
  ],
  [
    'Dynamic forms',
    'Versioned category fields and server-side validation rules',
  ],
  [
    'Dashboard',
    'Workload, status distribution, turnaround time, and SLA metrics',
  ],
]
